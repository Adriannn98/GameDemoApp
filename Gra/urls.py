...
urlpatterns = [
    ...
    path('all_heroes/', views.AllHeroesView.as_view(), name='hero_list'),
    path('all_monster/', views.AllMonstersView.as_view(), name='monster_list'),
    ...
    path('my_heroes/', views.MyHeroListView.as_view(), name='my_heroes_list'),
    path('create_game_for_hero/<int:id_hero>/', views.CreateGameForHero.as_view(), name='create_game_for_hero'),
    path('detail_game/<int:pk>/', views.GameDetailView.as_view(), name='game_detail'),
    path('stage_game/<int:pk>/', views.StageDetailView.as_view(), name='stage_detail'),
